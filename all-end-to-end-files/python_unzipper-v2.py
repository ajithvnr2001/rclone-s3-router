#!/usr/bin/env python3
"""
PYTHON UNZIPPER & MERGER (Fully Fixed Version + S3 Resume)
...
- **FIX**: Added missing 'json' import
- **FIX**: Fixed cp command flags for local merging
- **FIX**: Removed deprecated distutils dependency
- **FIX**: Syntax error in type hint (Optional[...])
- **FIX**: boto3 exception handling in ALL functions
...
def main():
    print("📦 PYTHON UNZIPPER & MERGER (Fully Fixed Version)")
    print("=" * 55)
    ...
    # FIX: Don't use shell=True with command strings
    try:
        subprocess.run(
            ["apt-get", "update"],
