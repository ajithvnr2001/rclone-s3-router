#!/usr/bin/env python3
"""
PYTHON UNZIPPER & MERGER (v5 - Final Production Release)
...
- Manager context manager for cleanup
"""
...
def main() -> None:
    print("* PYTHON UNZIPPER & MERGER (v5 - Final Production Release)")
    print("=" * 55)
    ...
    # Don't use shell=True with command strings
    try:
        subprocess.run(
            ["apt-get", "update"],
